...
![Interfaz de la aplicación](imagenes/interfaz_1.png)

1️⃣ Agregar Amigos

![Agregar amigo](imagenes/agregar_2.png)
...
![Lista de amigos](imagenes/lista_3.png)

Los nombres ingresados aparecerán en una lista debajo del campo de entrada.
3️⃣ Realizar el Sorteo

![Resultado del sorteo](imagenes/sorteo_4.png)
...
![Se sortean todos los amigos](imagenes/alerta_5.png)

4️⃣ Reiniciar el Juego

![Reinicio del juego](imagenes/reinicio_6.png)
